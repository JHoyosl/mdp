...
class map_local_index extends Seeder
{
	...
	public function run()
	{
		...
		$map_local_index = array(
			...
			array(
				'description' => 'NOMBRE CENTRO DE COSTOS',
				'type' => '0',
			),
			array(
				'description' => 'CODIGO CENTRO DE COSTOS',
				'type' => '0',
			),
			array(
			...
			array(
				'description' => 'NOMBRE CUENTA CONTABLE',
				'type' => '0',
			),
			array(
				'description' => 'NUMERO CUENTA CONTABLE',
				'type' => '0',
			),
			array(
				'description' => 'NOMBRE DE TERCERO',
				'type' => '0',
			),
			array(
				'description' => 'IDENTIFICACION DE TERCERO',
				'type' => '0',
			),
			array(
			...
			array(
				'description' => 'FECHA ORIGEN',
				'type' => '0',
			),
			array(
				'description' => 'OFICINA ORIGEN',
				'type' => '0',
			),
			array(
				'description' => 'OFICINA DESTINO',
				'type' => '0',
			),
			array(
				'description' => 'NUMERO LOTE',
				'type' => '0',
			),
			array(
				'description' => 'CONSECUTIVO LOTE',
				'type' => '0',
			),
			array(
