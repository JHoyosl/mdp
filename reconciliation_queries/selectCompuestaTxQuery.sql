...
LEFT JOIN 
    ...
    mdp.reconciliation_local_values_2.descripcion LIKE concat('%',mdp.reconciliation_local_tx_types_2.description)
WHERE 
	mdp.reconciliation_local_values_2.local_account  IN ('11100501') AND
	mdp.reconciliation_local_tx_types_2.type = 'COMPUESTA' AND 
