...
localValues.fecha_movimiento <= DATE_ADD(reconciliation_external_values_2.fecha_movimiento, INTERVAL 4 DAY) AND
    ...
    localValues.valor_debito=reconciliation_external_values_2.valor_credito AND
    localValues.tx_type_name=reconciliation_external_values_2.tx_type_name WHERE localValues.local_account IN
    (11100501,11100502,11100506,11100507) AND localValues.valor_debito> 0
