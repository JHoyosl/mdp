...
SELECT externalId, localId , 'CASE1', '7wu3DCENt' FROM
(SELECT
...
LEFT JOIN reconciliation_external_values_2 ON
localValues.fecha_movimiento = reconciliation_external_values_2.fecha_movimiento
...
AND (localValues.referencia_1 = reconciliation_external_values_2.referencia_2
OR localValues.referencia_2 = reconciliation_external_values_2.referencia_2
OR localValues.referencia_3 = reconciliation_external_values_2.referencia_2)
WHERE
...
AND localValues.fecha_movimiento BETWEEN '2023-09-01' AND '2023-09-30') AS CASE1PAGOS