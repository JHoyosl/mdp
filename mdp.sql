...
INSERT INTO `bancos` VALUES ('01','860002964-4','BANCO DE BOGOTA','COP',1),('13','860003020-1','BANCO BBVA','COP',1),('32','860007335-4','BANCO BCSC COLMENA','COP',1),('02','860007738-9','BANCO POPULAR','COP',1),('51','860034313-7','BANCO DAVIVIENDA','COP',1),('19','860034594-1','BANCO COLPATRIA','COP',1),('52','860035827-5','BANCO AV VILLAS','COP',1),('','860066942-7','COMPENSAR',NULL,NULL),('66','890203088-9|','BANCO COOPCENTRAL','COP',1),('23','890300279-4','BANCO DE OCCIDENTE','COP',1),('06','890903937-0','BANCO ITAU','COP',1),('07','890903938-8','BANCOLOMBIA','COP',1);
...
INSERT INTO `formato_empresa` VALUES ('900862658-9',12),('900862658-9',13);
...
CREATE TABLE `formato_mapeo` (
  ...
  `FUENTE` int(11) DEFAULT '0' COMMENT '0:Bancos, 1:Contabilidad',
  `ENCABEZADOS` int(11) DEFAULT '1',
  PRIMARY KEY (`ID`)
...
INSERT INTO `formato_mapeo` VALUES (6,'900862658-9','MOVIMIENTO','MOVIMIENTO DIARO','[\"1\", \"2\", \"3\", \"\", \"4\", \"7\", \"5\", \"8\", \"17\", \"16\", \"15\", \"10\", \"9\", \"9\", \"11\", \"6\", \"12\", \"13\", \"15\"]','[{\"type\": \"d\", \"title\": \"FECHA\", \"value\": \"2018-01-01\"}, {\"type\": \"s\", \"title\": \"NOMBRE_AGENCIA\", \"value\": \"SEDE PRINCIPAL\"}, {\"type\": \"null\", \"title\": \"NOMBRE_CENTROCOSTO\", \"value\": null}, {\"type\": \"s\", \"title\": \"NOMBRE_ESQUEMA\", \"value\": \"NIIF\"}, {\"type\": \"s\", \"title\": \"COMPROBANTE\", \"value\": \"EGRESO DF\"}, {\"type\": \"s\", \"title\": \"DESCRIPCION\", \"value\": \"Transferencia hacia la cuenta: 456200020497\"}, {\"type\": \"n\", \"title\": \"NUM_DOC\", \"value\": 20180114}, {\"type\": \"null\", \"title\": \"DOC_REF\", \"value\": null}, {\"type\": \"n\", \"title\": \"IDENTIFICATION\", \"value\": 1012336358}, {\"type\": \"s\", \"title\": \"TERCERO\", \"value\": \"NANCY CATALINA DAZA GOMEZ\"}, {\"type\": \"n\", \"title\": \"COMENTARIO\", \"value\": -1}, {\"type\": \"n\", \"title\": \"SALDO_ANTERIOR\", \"value\": 28011203}, {\"type\": \"n\", \"title\": \"DEBITO\", \"value\": 0}, {\"type\": \"n\", \"title\": \"CREDITO\", \"value\": 50827.08}, {\"type\": \"n\", \"title\": \"SALDO_ACTUAL\", \"value\": 27960375.92}, {\"type\": \"s\", \"title\": \"AD_USER\", \"value\": \"CDUCUARA\"}, {\"type\": \"n\", \"title\": \"CODIGO\", \"value\": 11100502}, {\"type\": \"s\", \"title\": \"NOMBRE\", \"value\": \"COLPATRIA CORRIENTE 121082330\"}, {\"type\": \"s\", \"title\": \"cuenta_nombre\", \"value\": \"Cuenta: 11100502 - COLPATRIA CORRIENTE 121082330\"}]','DIARIO',1,1),(8,'860034594-1','MOVIMIENTO COLPATRIA','MOVIMIENTO DIARO','[\"15\", \"8\", \"4\", \"18\", \"11\", \"6\", \"5\", \"2\", \"16\", \"10\", \"12\", \"12\"]','[{\"type\": \"csv\", \"title\": \"ID MOVIMIENTO\", \"value\": \"1\"}, {\"type\": \"csv\", \"title\": \"Naturaleza\", \"value\": \"D\"}, {\"type\": \"csv\", \"title\": \"Nit\", \"value\": \"8301434767\"}, {\"type\": \"csv\", \"title\": \"No Nota\", \"value\": \"0\"}, {\"type\": \"csv\", \"title\": \"Referencia\", \"value\": \"\"}, {\"type\": \"csv\", \"title\": \"Tipo Cuenta\", \"value\": \"Cuenta Corriente\"}, {\"type\": \"csv\", \"title\": \"No Cuenta\", \"value\": \"***************2330\"}, {\"type\": \"csv\", \"title\": \"Fecha\", \"value\": \"02/01/2018\"}, {\"type\": \"csv\", \"title\": \"Oficina\", \"value\": \"CENTRAL DE CANJ\"}, {\"type\": \"csv\", \"title\": \"Descripci?n\", \"value\": \"CN COBRO MES ACH 1217\"}, {\"type\": \"csv\", \"title\": \" Valor D?bito \", \"value\": \" -   \"}, {\"type\": \"csv\", \"title\": \" Valor Cr?dito \\r\", \"value\": \"\\r\"}]','DIARIO',0,1),(11,'890903938-8','MOVIMIENTO COLOMBIA','MOVIMIENTO DIARO','[\"2\", \"5\", \"15\", \"\", \"\", \"7\", \"10\", \"11\", \"12\", \"17\", \"8\", \"\", \"\", \"\", \"\", \"\"]','[{\"type\": \"csv\", \"title\": \"20180101\", \"value\": \"20180102\"}, {\"type\": \"csv\", \"title\": \" 171-539846-78\", \"value\": \" 171-539846-78\"}, {\"type\": \"csv\", \"title\": \" 1\", \"value\": \" 2\"}, {\"type\": \"csv\", \"title\": \" 1\", \"value\": \" 1\"}, {\"type\": \"csv\", \"title\": \" 171\", \"value\": \" 171\"}, {\"type\": \"csv\", \"title\": \" 0\", \"value\": \" 5000\"}, {\"type\": \"csv\", \"title\": \" SALDO INICIAL\", \"value\": \" CHEQUE GIRADO\"}, {\"type\": \"csv\", \"title\": \" 000000\", \"value\": \" 390259\"}, {\"type\": \"csv\", \"title\": \" 109626972.61\", \"value\": \" -13246810.00\"}, {\"type\": \"csv\", \"title\": \" 0\", \"value\": \" 30\"}, {\"type\": \"csv\", \"title\": \" C\", \"value\": \" D\"}, {\"type\": \"csv\", \"title\": \" \", \"value\": \" \"}, {\"type\": \"csv\", \"title\": \" \", \"value\": \" \"}, {\"type\": \"csv\", \"title\": \" \", \"value\": \" \"}, {\"type\": \"csv\", \"title\": \" \", \"value\": \" \"}, {\"type\": \"csv\", \"title\": \"                                                                                                   \\r\", \"value\": \"                                                                                               \\r\"}]','DIARIO',0,1),(12,'860035827-5','MOVIMIENTO VILLAS','MOVIMIENTO DIARO','[\"\", \"2\", \"10\", \"11\", \"16\", \"12\", \"\", \"15\", \"8\", \"7\"]','[{\"type\": \"csv\", \"title\": \"Cuenta Nro. 59005199  Movimiento Desde el 02-JUN-16 Al 09-JUN-16\", \"value\": \"Fecha de aplicacion\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Fecha de transaccion\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Descripcion\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"documento\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Origen\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Valor Total\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Valor Efectivo\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Valor Cheque\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"D- Debito C- Credito\"}, {\"type\": \"csv\", \"title\": \"\\r\", \"value\": \"Codigo de Transaccion\\r\"}]','DIARIO',0,1),(13,'860035827-5','MOVIMIENTO VILLAS REFEREN','MOVIMIENTO DIARO','[\"2\", \"\", \"16\", \"\", \"\", \"12\", \"11\", \"13\", \"14\", \"15\", \"8\"]','[{\"type\": \"csv\", \"title\": \"Cuenta Nro. 59005199  Movimiento Desde el 02-JUN-16 Al 09-JUN-16\", \"value\": \"Fecha de aplicacion\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Fecha de transaccion\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Origen\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Valor Efectivo\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Valor Canje\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Valor Total\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Referencia 1\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Referencia 2\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Referencia 3\"}, {\"type\": \"csv\", \"title\": \"\", \"value\": \"Referencia 4\"}, {\"type\": \"csv\", \"title\": \"\\r\", \"value\": \"Referencia 5\\r\"}]','DIARIO',0,1);
...
INSERT INTO `maestro_formato_contable` VALUES (1,'FECHA DE MOVIMIENTO',0),(2,'NOMBRE AGENCIA',0),(3,'NOMBRE CENTRO DE COSTOS',0),(4,'CODIGO CENTRO DE COSTOS',0),(5,'NUMERO DE COMPROBANTE',0),(6,'NOMBRE USUARIO',0),(7,'DESCRIPCION',0),(8,'REFERENCIA 1',1),(9,'VALOR',1),(10,'SALDO ANTERIOR',1),(11,'SALDO ACTUAL',1),(12,'NUMERO CUENTA CONTABLE',0),(13,'NOMBRE CUENTA CONTABLE',0),(14,'REFERENCIA 2',0),(15,'REFERENCIA 3',0),(16,'NOMBRE PROVEEDOR',0),(17,'IDENTIFICACION DE PROVEEDOR',0);
...
INSERT INTO `maestro_formato_recaudo` VALUES (1,'FECHA DEL ARCHIVO',0),(2,'FECHA DEL MOVIMIENTO',0),(3,'NOMBRE TITULAR',0),(4,'IDENTIFICACION TITULAR',0),(5,'NUMERO DE CUENTA',0),(6,'TIPO DE CUENTA',0),(7,'CODIGO DE TRANSACCION',0),(8,'TIPO DE TRANSACCION',1),(9,'NOMBRE DE TRANSACCION',0),(10,'DESCRIPCION',0),(11,'REFERENCIA 1',1),(12,'VALOR',1),(13,'REFERENCIA 2',0),(14,'REFERENCIA 3',0),(15,'CONSECUTIVO DE REGISTROS',1),(16,'NOMBRE OFICINA',0),(17,'CODIGO OFICINA',0),(18,'CANAL',0),(19,'NOMBRE PROVEEDOR',0),(20,'IDENTIFICACION DE PROVEEDOR',0),(21,'BANCO DESTINO',0),(22,'FECHA DE RECHAZO',0),(23,'MOTIVO DE RECHAZO',0);
...
-- Dump completed on 2018-06-14  2:51:50
